...
public class Trabalho {
    ...
    private Trabalho() {
        menus.put("1", "1 - PRODUTOS");
        menus.put("2", "2 - CARRINHO");
    ...
    public String getMenus(String nomeDoMenu) {
        return this.menus.get(nomeDoMenu);
    }

    public void setMenus(String nomeDoMenu, String valor) {
         this.menus.replace(nomeDoMenu, valor);
    }
